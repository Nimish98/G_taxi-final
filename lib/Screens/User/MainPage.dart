              ...
              children: [
                Container(
                  ...
                  child: DrawerHeader(
                    child: Row(
                      children: [
                        Image.asset("images/user_icon.png",height: MediaQuery.of(context).size.height*0.2,width: MediaQuery.of(context).size.width*0.2,),
                        SizedBox(
                ...
                ListTile(
                  onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Rentals()));
                  },
      ...
      body:Stack(
        children: [
          GoogleMap(
            ...
            padding: EdgeInsets.only(bottom: mapBottomPadding,top: MediaQuery.of(context).size.height*0.41,),
